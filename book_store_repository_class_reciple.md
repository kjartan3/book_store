...
all_books[0].id # =>  1
all_books[0].title # =>  'The Old Man and the Sea'
all_books[0].author_name # =>  'Ernest Hemingway'

all_books[1].id # =>  2
all_books[1].title # =>  'Cujo'
all_books[1].author_name # =>  'Stephen King'
...
single_book.id # =>  1
single_book.title # =>  'The Old Man and the Sea'
single_book.author_name # =>  'Ernest Hemingway'
